...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""MousePos"",
                    ""type"": ""Value"",
                    ""id"": ""65a6993b-bc4b-4a78-af51-4d8c2b2b3607"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""96eb775e-1a5e-45db-aead-95cedae0ff0b"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
        ...
        {
            ""name"": ""LoginScene"",
            ""id"": ""c4932ca9-22b7-4ed4-9a86-534a2230323e"",
            ""actions"": [
                {
                    ""name"": ""Tab"",
                    ""type"": ""Button"",
                    ""id"": ""dd14c4bc-2a41-417e-8487-cda5afdf7db5"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Enter"",
                    ""type"": ""Button"",
                    ""id"": ""bbed55e3-cb3e-4b59-853d-0b27bc28afe4"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4f95dc83-7efd-44a4-bb71-7473d666d5d9"",
                    ""path"": ""<Keyboard>/tab"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""91dae6dd-daf1-45b0-b7fc-3bcf45053555"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // LoginScene
        m_LoginScene = asset.FindActionMap("LoginScene", throwIfNotFound: true);
        m_LoginScene_Tab = m_LoginScene.FindAction("Tab", throwIfNotFound: true);
        m_LoginScene_Enter = m_LoginScene.FindAction("Enter", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_LoginScene.enabled, "This will cause a leak and performance issues, InputSystem_Actions.LoginScene.Disable() has not been called.");
    }
    ...
    // LoginScene
    private readonly InputActionMap m_LoginScene;
    private List<ILoginSceneActions> m_LoginSceneActionsCallbackInterfaces = new List<ILoginSceneActions>();
    private readonly InputAction m_LoginScene_Tab;
    private readonly InputAction m_LoginScene_Enter;
    /// <summary>
    /// Provides access to input actions defined in input action map "LoginScene".
    /// </summary>
    public struct LoginSceneActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public LoginSceneActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "LoginScene/Tab".
        /// </summary>
        public InputAction @Tab => m_Wrapper.m_LoginScene_Tab;
        /// <summary>
        /// Provides access to the underlying input action "LoginScene/Enter".
        /// </summary>
        public InputAction @Enter => m_Wrapper.m_LoginScene_Enter;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_LoginScene; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="LoginSceneActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(LoginSceneActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="LoginSceneActions" />
        public void AddCallbacks(ILoginSceneActions instance)
        {
            if (instance == null || m_Wrapper.m_LoginSceneActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_LoginSceneActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="LoginSceneActions" />
        private void UnregisterCallbacks(ILoginSceneActions instance)
        {
            @Tab.started -= instance.OnTab;
            @Tab.performed -= instance.OnTab;
            @Tab.canceled -= instance.OnTab;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="LoginSceneActions.UnregisterCallbacks(ILoginSceneActions)" />.
        /// </summary>
        /// <seealso cref="LoginSceneActions.UnregisterCallbacks(ILoginSceneActions)" />
        public void RemoveCallbacks(ILoginSceneActions instance)
        {
            if (m_Wrapper.m_LoginSceneActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="LoginSceneActions.AddCallbacks(ILoginSceneActions)" />
        /// <seealso cref="LoginSceneActions.RemoveCallbacks(ILoginSceneActions)" />
        /// <seealso cref="LoginSceneActions.UnregisterCallbacks(ILoginSceneActions)" />
        public void SetCallbacks(ILoginSceneActions instance)
        {
            foreach (var item in m_Wrapper.m_LoginSceneActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_LoginSceneActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="LoginSceneActions" /> instance referencing this action map.
    /// </summary>
    public LoginSceneActions @LoginScene => new LoginSceneActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "LoginScene" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="LoginSceneActions.AddCallbacks(ILoginSceneActions)" />
    /// <seealso cref="LoginSceneActions.RemoveCallbacks(ILoginSceneActions)" />
    public interface ILoginSceneActions
    {
        /// <summary>
